 ...
 */
@Data
public class ColumnDTOVO implements Serializable {
     ...
     * 主题的名称
     */
    @ApiModelProperty(value = "主题的名称",example = "",required = false)
    private String titleName;

    /**
     *  禁用、启用
     */
    @ApiModelProperty(value = "FALSE禁用、TRUE启用",example = "",required = false)
     ...
     *  是否有删除按钮
     */
    @ApiModelProperty(value = "是否有删除按钮,Y 表示有删除按钮,N 表示没有删除按钮",example = "",required = false)
    private String mark;
